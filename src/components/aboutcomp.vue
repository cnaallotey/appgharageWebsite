    ...
    <div class="flex flex-col md:flex-row space-y-10 md:space-y-0">
      <div class="space-y-5 w-full md:w-1/2 flex flex-col justify-start">
        <h1
          ...
          style="letter-spacing: 0.2px; font-size: 40px"
        >
          About Us
        </h1>
        <p
        ...
        >
          AppGharage Consultancy is a Digital transformation and consulting company
          focused on delivering innovative solutions for Small, Medium Scale Businesses
          and Enterprises with a proven track record in Product Development, Technology
          Consulting, and IT Outsourcing. Our Experience Design, Complex Engineering, and
          Agile Delivery gives you the best software product for better business outcomes.
        </p>
      </div>
