    ...
    <div class="flex flex-col md:flex-row space-x-0 md:space-x-20 space-y-5 md:space-y-0">
      <div class="w-full md:w-1/2 p-0 md:p-5">
        <img
          ...
          class="w-full md:transform hover:scale-110 transform-none ease-in-out delay-75 transition-transform"
          alt=""
        />
      </div>
      <div
        class="w-full md:w-1/2 pr-0 md:pr-5 pl-0 lg:pl-20 space-y-5 flex flex-col justify-center"
      >
        <h2 class="font-semibold tracking-normal text-gray-900" style="font-size: 24px">
        ...
        <a
          ...
          class="w-48 text-center py-3 font-normal text-white rounded-md"
