<template>
    ...
    <h1 class="font-bold text-gray-700 text-center md:text-left " style="font-size: 40px; letter-spacing:0.2px;">Products</h1>
        ...
        <div>
        <a href="https://ghanadutycalculator.com/estimates" class="px-10 py-3 font-normal text-white rounded-md" style="background-color: #b00000; font-size: 14px">Visit Website</a>
        </div></div>
