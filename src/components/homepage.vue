...
<div class="w-full md:w-1/2 px-14"><img src="../assets/screen.png" class="h-full" alt=""></div>
...
<div class="flex flex-col md:flex-row-reverse space-y-10 md:space-y-0 space-x-0 md:space-x-20">
<div class="w-full md:w-1/2 px-14"><img src="../assets/digitaltransformation.svg" class="h-full" alt=""></div>
<div class="w-full h-auto md:w-1/2 space-y-6 flex flex-col justify-center  pl-0 md:pl-20 lg:pl-40">
<h3 class=" font-semibold tracking-normal text-gray-900 " style="font-size: 24px;">Digital Transformation</h3>
<div class="flex flex-row space-x-2 items-center">
<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" style="color: #b00000;" viewBox="0 0 20 20" fill="currentColor">
  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
</svg>
...
<div class="flex flex-col md:flex-row space-y-10 md:space-y-0 space-x-0 md:space-x-20">
<div class="w-full md:w-1/2 px-14"><img src="../assets/consultancy.svg" class="h-full" alt=""></div>
<div class="w-full h-auto md:w-1/2 space-y-6 flex flex-col justify-center pl-0 md:pl-5 lg:pl-20">
<h3 class=" font-semibold tracking-normal text-gray-900 " style="font-size: 24px;">IT Consultancy Services</h3>
<div class="flex flex-row space-x-2 items-center">
<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" style="color: #b00000;" viewBox="0 0 20 20" fill="currentColor">
  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
</svg>
...
<div class="flex flex-col md:flex-row space-x-0 md:space-x-20 space-y-10 md:space-y-0">
        ...
        <h2 class=" font-semibold tracking-normal leading-normal text-gray-900" style="font-size: 24px; ">Ghana Vehicle Import Duty Estimater</h2>
        ...
        <a href="https://ghanadutycalculator.com/estimates" class="w-48 text-center py-3 font-normal cursor-pointer text-white rounded-md" style="background-color: #b00000; font-size: 14px">Visit Website</a>
        </div>
