      ...
      >
        ...
        >
          ...
          >
            ...
            <router-link
              to="/contact"
              class="w-full md:w-56 mx-auto md:mx-0 font-medium text-center py-3 rounded-none text-base bg-white text-red-600 border-2 border-red-700"
              >Get in touch with us</router-link
            >
          </div>
          <div class="flex items-center w-full md:w-1/3 py-5">
            <img :src="require(`../assets/${ctaimg}`)" class="mx-auto" alt="" />
          </div>
        </div>
      </div>
    </div>
